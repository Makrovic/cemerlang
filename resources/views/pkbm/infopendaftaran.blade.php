@extends('layout.base')
@section('meta_keywords', 'info pendaftaran,pkbm,pkbm cemerlang,info pendaftaran pkbm cemerlang wonosobo')
@section('meta_description', 'info pendaftaran PKBM CEMERLANG WONOSOBO')
@section('customcss')
                                ...
                                <li>Calon peserta didik menyerahkan dokumen persyaratan pendaftaran sebagai berikut :
                                    <ul>
                                        <li>Pas foto resmi menggunakan kemeja putih, berdasi, dan berjas, <span
                                            ...
                                            Ukuran 2x3 (10 lembar) dan 3x4 (10 lembar)</li>
    ...
    <section class="sec back-gray">
        <div class="container">
            ...
            <div data-aos="fade-up">
                ...
                <p>Jawaban : <br>Proses pembelajaran dilaksanakan secara online (daring) dan offline Pembelajaran Tatap Muka
                    (PTM).
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6 ">
                    <div class="card card-b my-2" data-aos="fade-up" data-aos-delay="100">
                        <div class="card-header">
                            Paket B Reguler / Mandiri
                        </div>
                        <div class="card-body">
                            <p>Biaya Pendidikan untuk Paket B Reguler/Mandiri yaitu <b>Rp.3.000.000,-</b> per tahun,
                ...
                <div class="col-lg-6 ">
                    <div class="card card-c my-2" data-aos="fade-up" data-aos-delay="100">
                        <div class="card-header">
                            Paket C Reguler / Mandiri
                        </div>
                        <div class="card-body">
                            <p>Biaya Pendidikan untuk Paket C Reguler/Mandiri yaitu <b>Rp.3.600.000,-</b> per tahun,
                ...
                <div class="col-lg-6 ">
                    <div class="card card-b my-2" data-aos="fade-up" data-aos-delay="100">
                        <div class="card-header">
                            Paket B Kolektif Desa atau Organisasi
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Biaya Pendidikan Kesetaraan Paket B Kolektif Desa atau Organisasi :
                            </h5>
                            <p>Biaya Pendidikan untuk Paket C Kolektif Desa atau Organisasi yaitu sebesar <b>Rp.
                                ...
                                Mandiri Lembaga yang bersumber dari Keuntungan Unit Usaha Lembaga sebesar <b>Rp.
                                    500.000,-</b>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td>Pembangunan Prasaran Pendidikan <br>(gedung/ruang pembelajaran)</td>
                                            <td>500.000,-</td>
                ...
                <div class="col-lg-6 ">
                    <div class="card card-c my-2" data-aos="fade-up" data-aos-delay="100">
                        <div class="card-header">
                            Paket C Kolektif Desa atau Organisasi
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Biaya Pendidikan Kesetaraan Paket C Kolektif Desa atau Organisasi :
                            </h5>
                            <p>Biaya Pendidikan untuk Paket C Kolektif Desa atau Organisasi yaitu sebesar <b>Rp.
