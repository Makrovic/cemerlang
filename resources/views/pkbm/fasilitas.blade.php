@extends('layout.base')
@section('meta_keywords', 'fasilitas,pkbm,pkbm cemerlang,fasilitas pkbm cemerlang wonosobo')
@section('meta_description', 'fasilitas PKBM CEMERLANG WONOSOBO')
@section('customcss')
            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="fa-ul">
                        ...
                        <li><span class="fa-li"><i class="bullet fas fa-check-circle"></i></span>Peserta didik
                            ditempatkan
