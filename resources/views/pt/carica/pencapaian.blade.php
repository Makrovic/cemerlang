        ...
        <div class="col-sm-12 col-md-6">
            <div class="swiper sw-oneslide">
                <div class="swiper-wrapper">
                    @for ($i = 1; $i <= 4; $i++) <div
                        class="swiper-slide d-flex justify-content-center align-items-center">
                        <a href="{{ asset('images/pt/event/tradeexport' . $i . '.jpg') }}" data-lightbox="image-2">
        ...
        <div class="col-sm-12 col-md-6">
            <div class="swiper sw-oneslide">
                <div class="swiper-wrapper">
                    @for ($i = 1; $i <= 5; $i++) <div
                        class="swiper-slide d-flex justify-content-center align-items-center">
                        <a href="{{ asset('images/pt/event/jemputrezeki' . $i . '.jpg') }}" data-lightbox="image-3">
            ...
            <div class="swiper-wrapper">
                @for ($i = 1; $i <= 3; $i++) <div class="swiper-slide d-flex justify-content-center align-items-center">
                    <a href="{{ asset('images/pt/event/fsi' . $i . '.jpg') }}" data-lightbox="image-4">
                        <img src="{{ asset('images/pt/event/fsi' . $i . '.jpg') }}" class="figure-img img-fluid rounded"
        ...
        <div class="col-sm-12 col-md-6">
            <div class="swiper sw-oneslide">
                <div class="swiper-wrapper">
                    @for ($i = 1; $i <= 3; $i++) <div
                        class="swiper-slide d-flex justify-content-center align-items-center">
                        <a href="{{ asset('images/pt/event/kurasiexport' . $i . '.jpg') }}" data-lightbox="image-3">
