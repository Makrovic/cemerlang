                            ...
                            <div class="card text-center card-product">
                                <a class="m-2"
                                    ...
                                    <div class="img-box-zoom">
                                        <img src="{{ asset('images/pt/produk/' . $produk->foto . '.jpg') }}"
            ...
            <div class="row g-2" data-aos="zoom-in">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="row flex-row align-items-center">
                        <div class="col p-3">
                            <img src="{{ asset('images/pt/sertifikasi/bpom.png') }}" class="img-fluid"
                                alt="sertif-bpom">
                        </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="row flex-row align-items-center">
                        <div class="col p-3">
                            <img src="{{ asset('images/pt/sertifikasi/mui.png') }}" class="img-fluid"
                                alt="sertif-mui">
                        </div>
                        <div class="col-sm-12 col-md-8 col-lg-8">
                            <p>Produk CARICA CEMERLANG
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="row flex-row align-items-center">
                        <div class="col p-3">
                            <img src="{{ asset('images/pt/sertifikasi/gmp.png') }}" class="img-fluid"
                                alt="sertif-gmp">
                        </div>
                        <div class="col-sm-12 col-md-8 col-lg-8">
                            <p>Produk CARICA CEMERLANG
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="row flex-row align-items-center">
                        <div class="col p-3">
                            <img src="{{ asset('images/pt/sertifikasi/pls.png') }}" class="img-fluid"
                                alt="sertif-pls">
                        </div>
                        <div class="col-sm-12 col-md-8 col-lg-8">
                            <p>Produk CARICA CEMERLANG
